...
const FieldVisit = ({ title }) => {
    ...
    const [totalJarakSurvey, setTotalJarakSurvey] = useState(0);
    const [totalJarakKunjungan, setTotalJarakKunjungan] = useState(0);
                                                                                                                ...
                                                                                                                <div className="w-full flex flex-row gap-2 justify-between">
                                                                                                                    {images.map((image, index) => (
                                                                                                                        <ImagePreview key={index}
                                                                                                                            src={`${ImageURLKoplink}rumah/${image}`} alt="Foto Rumah" className="w-50 h-30 object-cover rounded-md" />
                                                                                                                    ))}
