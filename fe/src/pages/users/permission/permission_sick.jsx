...
const PagePermissionSick = ({ title }) => {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object().shape({
            ...
            file_dokumen: yup.mixed().nullable().optional(), // tidak wajib
        })
    })
                ...
                <div className="bg-white p-4 rounded-md border flex flex-col gap-4">
                    ...
                    <form action={formik.handleSubmit}>
                        <div className="flex flex-col gap-4">
                            ...
                            <Field>
                                <FieldLabel>Dokumen (opsional)</FieldLabel>
                                <FieldContent>
                                    <Input
                                        id="file_dokumen"
                                        name="file_dokumen"
...
export default PagePermissionSick