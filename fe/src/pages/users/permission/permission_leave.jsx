...
const PagePermissionLeave = ({ title }) => {
                                    ...
                                    <FieldContent>
                                        <Select
                                            ...
                                            onValueChange={(value) => {
                                                ...
                                                formik.setFieldTouched("jenis_cuti", true)
                                            }}

                                            value={formik.values.jenis_cuti}
                                        >
                                            <SelectTrigger className="w-full" id="jenis_cuti">
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="pernikahan">Cuti Pernikahan </SelectItem>
                                                <SelectItem value="duka">Cuti Duka</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </FieldContent>
                                    {formik.errors.jenis_cuti && (
                                        <span className="text-sm text-destructive">{formik.errors.jenis_cuti}</span>
                                    )}
                                </Field>
                                <Field>
...
export default PagePermissionLeave