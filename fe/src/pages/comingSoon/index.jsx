...
const ComingSoon = () => {
    return (
        <div className="mx-auto min-h-screen flex flex-col items-center justify-center text-2xl font-bold gap-4">
            <img src={ComingSoonImg} alt="coming soon" className="lg:w-1/3 lg:h-1/3 object-contain animate-float" />
